  ...
  return class AppWithRedux extends React.Component {
    static async getInitialProps(appContext) {
      ...
      if (isServer) {
        ...
        // fetch prefered champ and summoner client side instead of here
        // const {
        //   prefSummoner,
        //   prefChamp,
        //   prefRegion,
        ...
        // if (prefSummoner) {
        //   await dispatch(fetchSummoner(prefRegion, prefSummoner));
        // }
        // if (prefChamp && prefChamp.hasOwnProperty("name")) {
        //   const champName = prefChamp.name
        //     .replace(/([^a-z]+)/gi, "")
        //     .toLowerCase();

        //   await dispatch(fetchChamp(prefElo, champName, prefChamp.id));
        //   await dispatch(
