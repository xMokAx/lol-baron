...
const ChampCharts = ({ roleData, champName }) => {
  ...
  const winsByMatchesPlayedData = winsByMatchesPlayed
    ? [
        {
          matchesPlayed: "1-50",
  ...
  return (
    <React.Fragment>
          ...
          >
            ...
            <defs>
              <linearGradient id="champColor" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#b86bff" stopOpacity={0.6} />
                <stop offset="95%" stopColor="#b86bff" stopOpacity={0} />
              </linearGradient>
            </defs>
            <XAxis
              dataKey="matchLength"
      ...
      <div className="column is-12-mobile is-6-tablet is-6-desktop has-border-right">
        ...
        {winsByMatchesPlayedData.length ? (
